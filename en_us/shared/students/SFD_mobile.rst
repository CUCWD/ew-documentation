...
################################
The EducateWorkforce Mobile App
################################

.. The following paragraph describes the features of the EducateWorkforce mobile app for partners/educateworkforce.com (video only)
.. Alison, DOC-1840, June 2015

.. only:: Partners

  The EducateWorkforce mobile apps are companions to the `educateworkforce.com`_ website. You can use the
...
.. The following paragraph describes the features of the EducateWorkforce mobile app for Open EducateWorkforce (adds notifications, assessments, discussions)
.. Alison, DOC-1840, June 2015

.. only:: Open_EducateWorkforce

  You can use the EducateWorkforce mobile apps to download course videos so that you can
...
The is currently an EducateWorkforce mobile app for Android smartphones and another for
iPhones.
...
.. The following general Q&A applies to the EducateWorkforce mobile app for partners/educateworkforce.com only
.. Alison, DOC-1840, June 2015
...
.. The following getting started Q&A applies to the EducateWorkforce mobile app for partners/educateworkforce.com only
.. Alison, DOC-1840, June 2015
...
.. only:: Partners
  ...
  Not at this time. With the EducateWorkforce mobile app, you can download course videos to
...
.. only:: Open_EducateWorkforce
  ...
  Not entirely. With the EducateWorkforce mobile app, you can download course videos to
...
.. The following paragraph describes the features of the EducateWorkforce mobile app for partners/educateworkforce.com
.. Alison, DOC-1840, June 2015

.. only:: Partners

  Right now, you cannot use the EducateWorkforce mobile apps to participate in course
...
.. only:: Open_EducateWorkforce
  ...
  You can read and contribute to course discussions in the EducateWorkforce mobile apps
...
.. The following image includes section-level downloads, available to partners/educateworkforce.com (video only)
.. Alison, DOC-1840, June 2015
...
.. The following image is an early version of what will be available eventually for everyone; currently only for Open EducateWorkforce (adds notifications, assessments, discussions)
.. Alison, DOC-1840, June 2015
...
.. only:: Open_EducateWorkforce
  ...
  .. image:: ../../shared/students/Images/Mob_DownloadIcon_openEducateWorkforce.png
    :width: 300
...
any video can result in heavy data use. EducateWorkforce recommends using a Wi-Fi connection
if you intend to watch or download a lot of videos. The EducateWorkforce mobile apps have a
...
.. The following section describes how push notifications appear on devices with the EducateWorkforce mobile app installed
...
.. The following section describes the assessment types that appear on devices with the EducateWorkforce mobile app installed
.. Alison, DOC-1840, June 2015
