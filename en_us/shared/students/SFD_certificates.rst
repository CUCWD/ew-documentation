...
This section describes EducateWorkforce certificates and how you access them.
...
.. only:: Partners
  ...
  .. note:: 
    A small number of EducateWorkforce courses do not offer certificates. For evidence that
...
A certificate includes your name, the name of the course, and the EducateWorkforce partner
...
available for EducateWorkforce course work.

.. only:: Partners

  .. Note:: 
    Some EducateWorkforce courses offer academic credit. These courses have different
...
.. only:: Partners
    ...
    EducateWorkforce offers three types of certificates. You select the certificate type
    ...
    .. image:: ../../shared/students/Images/SFD_HCCert.png
       :width: 500
       :alt: Example EducateWorkforce honor code certificate
    ...
    Some EducateWorkforce courses offer verified certificates. A verified certificate shows
    not only that you successfully completed your EducateWorkforce course, but also that you
    ...
    .. image:: ../../shared/students/Images/SFD_VerCert.png
       :width: 500
       :alt: Example EducateWorkforce verified certificate

    If a course offers verified certificates, you see a "Verified" badge on the
    course image in the list of courses on educateworkforce.com.

    .. image:: ../../shared/students/Images/SFD_VerifiedBadge.png
       :width: 200
       :alt: Image of DemoX course listing with a verified badge

    For a list of all courses that offer verified certificates, see the `EducateWorkforce
    course catalog`_.

    Verified certificates are available for a fee that varies by course. The
    fee helps support EducateWorkforce. If you want to donate to EducateWorkforce, you can choose to pay
    ...
    .. note:: When you verify your identity for one course, you verify your 
     identity for all EducateWorkforce courses. Verification is effective for one year. If
    ...
    contact EducateWorkforce at `support@educateworkforce.com <mailto://support@educateworkforce.com>`_. Include your
    ...
    badge on the course image in the list of courses on educateworkforce.com.

    .. image:: ../../shared/students/Images/SFD_XseriesBadge.png
       :width: 200
       :alt: An image of the DemoX course listing with a verified badge.

    For a list of all courses that are part of an XSeries program, see the `EducateWorkforce
    course catalog`_.
    ...
    * To change from a verified certificate to an honor code certificate, go to
      ...
      course. The EducateWorkforce support team will contact you with information about a
    ...
    If you have questions about changing your certificate type, contact the EducateWorkforce
    support team at `support@educateworkforce.com <mailto://support@educateworkforce.com>`_.
...
Newer EducateWorkforce courses issue web-based certificates. You access your web-based
...
Older EducateWorkforce courses issued PDF certificates. You can access your PDF certificates
...
While most EducateWorkforce courses have specific start and end dates, some courses are
