...
project = u'EducateWorkforce'
copyright = u'{copyright_year}, EducateWorkforce Doc Team'.format(copyright_year="2009 - " + str(date.today().year))
...
latex_documents = [
  ('index', 'getting_started.tex', u'EducateWorkforce CMS Documentation',
   u'EducateWorkforce Doc Team', 'manual'),
]
...
texinfo_documents = [
  ('index', 'getting_started', u'getting_started Documentation',
   u'EducateWorkforce Doc Team', 'getting_started', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_author = u'EducateWorkforce Doc Team'
epub_publisher = u'EducateWorkforce Doc Team'
epub_copyright = u'{copyright_year}, EducateWorkforce Doc Team'.format(copyright_year="2009 - " + str(date.today().year))
